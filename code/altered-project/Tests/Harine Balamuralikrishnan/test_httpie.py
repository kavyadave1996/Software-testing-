...
@pytest.mark.skip(reason="Crashes due to socket/http interaction during offline run")
...
@pytest.mark.skip(reason="Crashes due to socket/http interaction with local server")
@pytest.mark.parametrize('pretty', ['format', 'none'])
